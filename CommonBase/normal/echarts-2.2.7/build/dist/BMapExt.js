/**
     ...
     * @constructor
     */
    function GBMapExt(obj, BMap, ec, mapOption) {
     ...
     * @private
     */
    GBMapExt.prototype._echartsContainer = null;
     ...
     * @private
     */
    GBMapExt.prototype._mapOffset = [0, 0];
     ...
     * @private
     */
    GBMapExt.prototype._init = function (obj, BMap, ec, mapOption) {
        var self = this;
